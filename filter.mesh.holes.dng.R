...
#save(mesh.dng, file = "mesh.dng.RData")
...
local.plot.field.book(
  res.dng[[26]]$summary.random$i$sd)
local.plot.field.book(
  res.dng[[40]]$summary.random$i$sd)
#for c(0.01,0.3)
local.plot.field.book(
  res.dng[[28]]$summary.random$i$sd)
local.plot.field.book(
  res.dng[[42]]$summary.random$i$sd)
# [38] 1,1 [39] 0.01,0.01 [40] 0.01,1 [41] 0.01,0.2 [42] 0.01,0.3 [43] 0.01,0.5 [44] 0.01,0.7 [45] 0.01,0.8
par(mfrow = c(2,4))
local.plot.field.book(
  res.dng[[38]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[39]]$summary.random$i$sd)
local.plot.field.book(
  res.dng[[40]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[41]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[42]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[43]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[44]]$summary.random$i$sd, zlim = c(0,3.5))
local.plot.field.book(
  res.dng[[45]]$summary.random$i$sd, zlim = c(0,3.5))

local.plot.field.book(
  res.dng[[38]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[39]]$summary.random$i$mean)
local.plot.field.book(
  res.dng[[40]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[41]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[42]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[43]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[44]]$summary.random$i$mean, zlim = c(-1,6))
local.plot.field.book(
  res.dng[[45]]$summary.random$i$mean, zlim = c(-1,6))
...
##all possible plots tp choose the aesthetics
local.plot.field.book(
  res.dng[[41]]$summary.random$i$mean, zlim = c(-1,6))
plot(poly.bar1.new, add = TRUE, col = alpha("snow3", 0.5), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("pink", 0.5), lty = 0) #alpha("pink", 0.8)
...
#poly.bar with solid colors
local.plot.field.book(
  res.dng[[41]]$summary.random$i$mean,
  asp = 1,
  xlim = c(-975, -895),
  ylim = c(2860, 2950), axes =F)
plot(poly.bar1.new, add = TRUE, col = "snow3", lty = 0)
plot(poly.bar2.new, add = TRUE, col = "pink", lty = 0) #alpha("pink", 0.8)
plot(poly.water.book, add = T, col = "white", lty = 0)
points(xy[,1], xy[,2], pch = 20, col = "black")

local.plot.field.book(
  res.dng[[45]]$summary.random$i$mean,
  asp = 1,
  xlim = c(-975, -895),
  ylim = c(2860, 2950), axes =F)
plot(poly.bar1.new, add = TRUE, col = "snow3", lty = 0)
...
##mean
statist <- "mean"
fp <- file.path("plots/dng", paste0("zoom", zoom, "/zlim", zlim1, "/", statist))
if (!dir.exists(fp)) dir.create(fp, recursive = TRUE)
path = fp

for (j in 1:nrow(x)) {
  fpp <- file.path(paste0(path, "/", "b1_", x[j,1], "b2_", x[j,2], ".png"))
  
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$mean,
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(-1,6))
  plot(poly.bar1.new, add = TRUE, col = alpha("snow3",1), lty = 0)
  plot(poly.bar2.new, add = TRUE, col = alpha("pink", 1), lty = 0)
...
zlim2 <- c(10, 180)
for (z in 1:length(zlim2)) {
  for (j in 2) {
    fpp <- file.path(paste0(path, "/", "b1_", x[j,1], "b2_", x[j,2], "_zlim", zlim2[z], ".png"))
    #png(fpp)
...
for (j in 1:nrow(x)) {
  ...
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$sd,
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(0,3.7))
...
for (j in 1:nrow(x)) {
  ...
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$'0.025quant',
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(-7.8,3.5))
  plot(poly.bar1.new, add = TRUE, col = alpha("snow3",1), lty = 0)
  plot(poly.bar2.new, add = TRUE, col = alpha("pink", 1), lty = 0)
  plot(poly.water.book2, add = T, col = "white", lty = 0)
  points(xy[,1], xy[,2], pch = 20, col = alpha("black", 0.6))
...
for (j in 1:nrow(x)) {
  ...
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$'0.5quant',
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(-1.5,6))
...
for (j in 1:nrow(x)) {
  ...
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$'0.975quant',
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(0,11.5))
  plot(poly.bar1.new, add = TRUE, col = alpha("snow3",1), lty = 0)
  plot(poly.bar2.new, add = TRUE, col = alpha("pink", 1), lty = 0)
  plot(poly.water.book2, add = T, col = "white", lty = 0)
  points(xy[,1], xy[,2], pch = 20, col = alpha("black", 0.6))
...
for (j in 1:nrow(x)) {
  ...
  #png(fpp)
  local.plot.field.book(
    res.dng[[37+j]]$summary.random$i$mode,
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919),
    axes = F, zlim = c(-1.7,6))
...
###########################################################################################################
#PRED VALS, zoom 0, zlim low, maybe with zoom

#pred values don't look good, for the mode they go from 0.01 to ~0.15, 
#but then the quantiles are are too high or too low and if I put on the same scale everything is one colo for the mode
...
bar1.new.id <- c(bar1.new$'0.000190358376130462', bar1.new$'1', bar1.new$'0.504909630864859')
bar1.new <- unlist(bar1.new)
...
bar2.new$'0.376775514567271' <- c(bar2.new$'0.376775514567271', id.csc2)
#this '..' is not the same for all
bar2.new.id <- c(bar2.new$'0.729720370145515', bar2.new$'0.376775514567271')
bar2.new <- unlist(bar2.new)
...
bar3.id <- bar3
bar3.id <- bar3.id$'0.937950977357104'
...
sum(setdiff(bar3$'0.937950977357104', bar2.new.id)) + sum(intersect(bar2.new.id, bar3.id)) == sum(bar3$'0.937950977357104')
bar3$'0.937950977357104' <- setdiff(bar3$'0.937950977357104', bar2.new.id)
#bar3 again without the tri in bar2.new
bar3.id <- bar3$'0.937950977357104'
bar3 <- unlist(bar3)
...
gg_mesh.bars3 +
  geom_sf(data = st_as_sf(loc.sea.center.sp3), col = "green") +
  xlim(c(-950, -910)) +
  ylim(c(2860,2895))

############################################################################################################
#model using new bars and bar3
fem <-  inla.barrier.fem.plus(mesh.dng, list(bar1.new, bar2.new, bar3))
barrier.triangles <- list(bar1.new, bar2.new, bar3)

x3 <- matrix(c(0.01, 0.01, 0.01,
               0.01, 1, 0.01,
               0.01, 0.01, 0.5,
               0.01, 0.2, 0.5), ncol = 3, byrow = TRUE)
...
for (k in 1:3) {
  ...
  model[[k+45]] <- tbm
  formula[[k+45]] <- y ~ 0 + b0 + f(i, model =  tbm)
  
  res.dng[[k+45]] <- inla(formula[[k+45]],
                          data = inla.stack.data(joint.stk),
                          family = 'poisson', 
                          control.predictor = list(A = inla.stack.A(joint.stk), link = 1), 
                          E = inla.stack.data(joint.stk)$e, 
...
par(mfrow=c(2,3))
local.plot.field.book(
  res.dng[[46]]$summary.random$i$mean) 
local.plot.field.book(
  res.dng[[47]]$summary.random$i$mean)

local.plot.field.book(
  res.dng[[48]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("blue", 1), lty = 0)
plot(poly.bar3, add = T, col = "turquoise", lty = 0)
points(xy[,1], xy[,2], pch = 20, col = alpha("black", 0.6))


local.plot.field.book(
  res.dng[[48]]$summary.random$i$sd)#, zlim = c(0, 20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("blue", 1), lty = 0)
plot(poly.bar3, add = T, col = "turquoise", lty = 0)
points(xy[,1], xy[,2], pch = 20, col = alpha("black", 0.6))
...
gg_mesh.bars3 +
  ...
  ylim(ylim_)
local.plot.field.book(
  res.dng[[48]]$summary.random$i$sd, 
  xlim = xlim_, ylim = ylim_)
...
id.csc <- match(csc[,1], posTri_[,1]) 
bar2.new <- over(sp.b2, SpatialPoints(posTri), returnList=T)
bar2.new$'0.729720370145515' <- c(bar2.new$'0.729720370145515', id.csc)
bar2.new.id <- bar2.new$'0.729720370145515'
...
intersect(bar2.new$'0.729720370145515', id.csc2)
bar2.new$'0.729720370145515' <- c(bar2.new$'0.729720370145515', id.csc2)
bar2.new.id <- bar2.new$'0.729720370145515'
bar2.new <- unlist(bar2.new)
...
bar3.new$'0.937950977357104' <- bar3.new$'0.937950977357104'[!bar3.id %in% bar2.new.id]
...
par(mfrow=c(3,5))
local.plot.field.book(
  res.dng[[49]]$summary.random$i$sd) 
local.plot.field.book(
  res.dng[[50]]$summary.random$i$sd)
local.plot.field.book(
  res.dng[[51]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[52]]$summary.random$i$sd)#, zlim = c(-11,20))

local.plot.field.book(
  res.dng[[53]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[54]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[55]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[56]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[57]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[58]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[59]]$summary.random$i$sd)#, zlim = c(-11,20))

#mean
par(mfrow=c(3,5))
local.plot.field.book(
  res.dng[[49]]$summary.random$i$mean) 
local.plot.field.book(
  res.dng[[50]]$summary.random$i$mean)
local.plot.field.book(
  res.dng[[51]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[52]]$summary.random$i$mean)#, zlim = c(-11,20))

local.plot.field.book(
  res.dng[[53]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[54]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[55]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[56]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[57]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[58]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[59]]$summary.random$i$mean)#, zlim = c(-11,20))
...
par(mfrow=c(4,3))
local.plot.field.book(
  res.dng[[60]]$summary.random$i$sd) 
local.plot.field.book(
  res.dng[[61]]$summary.random$i$sd)
local.plot.field.book(
  res.dng[[62]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[63]]$summary.random$i$sd)#, zlim = c(-11,20))

local.plot.field.book(
  res.dng[[64]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[65]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[66]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[67]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[68]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[69]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[70]]$summary.random$i$sd)#, zlim = c(-11,20))

local.plot.field.book(
  res.dng[[71]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[72]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[73]]$summary.random$i$sd)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[74]]$summary.random$i$sd)#, zlim = c(-11,20))
##mean
par(mfrow=c(3,4))
local.plot.field.book(
  res.dng[[60]]$summary.random$i$mean) 
local.plot.field.book(
  res.dng[[61]]$summary.random$i$mean)
local.plot.field.book(
  res.dng[[62]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[63]]$summary.random$i$mean)#, zlim = c(-11,20))

local.plot.field.book(
  res.dng[[64]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[65]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[66]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[67]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[68]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[69]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[70]]$summary.random$i$mean)#, zlim = c(-11,20))
local.plot.field.book(
  res.dng[[71]]$summary.random$i$mean)#, zlim = c(-11,20))

##
local.plot.field.book(
  res.dng[[72]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[73]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[74]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)


local.plot.field.book(
  res.dng[[75]]$summary.random$i$mean) 
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[76]]$summary.random$i$mean)
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[77]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[78]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)


local.plot.field.book(
  res.dng[[79]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[80]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[81]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

local.plot.field.book(
  res.dng[[82]]$summary.random$i$mean)#, zlim = c(-11,20))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)

#########################################################
#probando colores
local.plot.field.book(
  res.dng[[83]]$summary.random$i$mean,
  xlim = c(-950, -905),
  ylim = c(2870, 2915),
  axes = F)
plot(poly.bar1.new, add = TRUE, col = alpha("tan4",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("tan", 1), lty = 0)
plot(poly.bar3, add = T, col = alpha("rosybrown1", 1), lty = 0)
plot(poly.water.book2, add = T, col = "white", lty = 0)
plot(sp4deep.sea, add = T, col = "white", lty = 0)
...
local.plot.field.book(
  ...
  axes = F)
plot(poly.bar1.new, add = TRUE, col = alpha("#996633",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("#003333", 0.9), lty = 0)
plot(poly.bar3, add = T, col = alpha("#99CCCC", 0.6), lty = 0)
...
local.plot.field.book(
  ...
  axes = F)
plot(poly.bar1.new, add = TRUE, col = alpha("#996633",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("#000333", 0.8), lty = 0)
plot(poly.bar3, add = T, col = alpha("#99CCCC", 0.6), lty = 0)
...
plot(poly.bar1.new, add = TRUE, col = alpha("#996633",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("#000333", 0.8), lty = 0)
plot(poly.bar3, add = T, col = alpha("#336666", 0.6), lty = 0)
...
local.plot.field.book(
  ...
  ylim = c(2870, 2919),
  axes = F)
plot(poly.bar1.new, add = TRUE, col = alpha("#003333",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("#336666", 0.7), lty = 0)
plot(poly.bar3, add = T, col = alpha("#99CCCC", 0.6), lty = 0)

local.plot.field.book(
  res.dng[[83]]$summary.random$i$mean, zlim = c(0,6))
plot(poly.bar1.new, add = TRUE, col = alpha("wheat",1), lty = 0)
plot(poly.bar2.new, add = TRUE, col = alpha("blue", 0.5), lty = 0)
plot(poly.bar3, add = T, col = alpha("turquoise", 0.5), lty = 0)
...
#########################################################################################################################################
#zoom in that Janet put on tha paper
#i'm correcting it because I think Janet just did a close up
...
#########################################################################################################################################
load("plots/dng/lists/res.dng.RData")
load("plots/dng/lists/mesh.dng.RData")
mesh <- mesh.dng
length(res.dng)
res.dng.sel <- res.dng[c(88,89,90,91)]
#saveRDS(res.dng.sel, "plots/dng/lists/res.dng.sel.rds")
rm(res.dng)
rm(pre.field)
#check
ls()
...
res.dng.sel <- readRDS("plots/dng/lists/res.dng.sel.rds")
res.dng <- res.dng.sel
res.dng[[3]] <- res.dng.sel[[4]]
res.dng[[4]] <- res.dng.sel[[3]]
#rm(res.dng.sel)

x.draft <- matrix(c(0.01, 0.1, 0.2, 
                    0.01, 0.1, 1,
                    0.01, 1, 1,
                    1, 1, 1), nrow = 4, ncol = 3, byrow = TRUE)

fp <- file.path("plots/dng", paste0("zoom"))
if (!dir.exists(fp)) dir.create(fp, recursive = TRUE)
path = fp


for (j in 1:nrow(x.draft)) {
  fpp <- file.path(paste0(path, "/", "b1_", x.draft[j,1], "b2_", x.draft[j,2], "b3_", x.draft[j,3], ".png"))
  png(fpp)
  local.plot.field.book(
    res.dng[[j]][[1]]$summary.random$i$mean,
    #  asp = 1,
    xlim = c(-940, -915),
    ylim = c(2895, 2913), zlim = c(-0.5,5.1), axes = F)
  plot(poly.bar1.new, add = TRUE, col = alpha("white",1), lty = 0)
  plot(poly.bar1.new, add = TRUE, col = alpha("#996633",0.5), lty = 0)
  plot(poly.bar2.new, add = TRUE, col = alpha("azure3", 0.6), lty = 0)
  #plot(poly.bar3, add = T, col = alpha("white", 0.8), lty = 0)
  plot(poly.water.book2, add = T, col = "white", lty = 0)
  #plot(sp4deep.sea, add = T, col = alpha("#000333", 0.7), lty = 0)
  points(xy[,1], xy[,2], pch = 20, col = alpha("black", 1))
  dev.off()
  
}

for (j in 1:nrow(x.draft)) {
  fpp <- file.path(paste0(path, "/", "b1_", x.draft[j,1], "b2_", x.draft[j,2], "b3_", x.draft[j,3], ".blue.png"))
  png(fpp)
  local.plot.field.book(
    res.dng[[j]][[1]]$summary.random$i$mean,
    #  asp = 1,
  ...
  plot(poly.bar1.new, add = TRUE, col = alpha("#996633",0.5), lty = 0)
  #plot(poly.bar2.new, add = TRUE, col = alpha("azure3", 0.6), lty = 0)
  plot(poly.bar3, add = TRUE, col = alpha("lightblue", 0.3), border = "lightblue", lty = 1, lwd = 3)
  plot(poly.water.book2, add = T, col = "white", lty = 0)
  #plot(sp4deep.sea, add = T, col = alpha("#000333", 0.7), lty = 0)
  points(xy[,1], xy[,2], pch = 20, col = alpha("black", 1))
  dev.off()
...
#########################################################################################################################################
#plot dng posterior with square for zoom in the next figure on the draft (the figure plotted right before)
zoom.perimeter <- SpatialPolygons(list(Polygons(list(Polygon(
  matrix(c(-940, 2895,
           -915, 2895,
           -915, 2913,
           -940, 2913,
           -940, 2895), ncol = 2, byrow = TRUE),
  FALSE)), '0')), proj4string = crs_km)
plot(zoom.perimeter)
...
for (j in 1:nrow(x.draft)) {
  ...
  local.plot.field.book(
    ...
    #  asp = 1,
    xlim = c(-960, -905),
    ylim = c(2870, 2919), axes = F, zlim = c(-1,6))
  plot(poly.bar1.new, add = TRUE, col = alpha("white",1), lty = 0)
  plot(poly.bar1.new, add = TRUE, col = alpha("#996633",0.5), lty = 0)
  plot(poly.water.book2, add = T, col = "white", lty = 0)
  plot(sp4deep.sea, add = T, col = alpha("#000333", 0.7), lty = 0)
  plot(zoom.perimeter, add = T, col = alpha("lightblue", 0), border = "black", lty = 1, lwd = 10)
  points(xy[,1], xy[,2], pch = 20, col = alpha("black", 0.6))
  dev.off()
